<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    @if ($isOpenCreateModal)
        <div>
            <div
                class="overflow-y-auto overflow-x-hidden flex justify-center items-center top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
